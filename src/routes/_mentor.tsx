...
export const Route = createFileRoute('/_mentor')({
  beforeLoad: async () => {
    ...
    // Allow mentors and admins to access mentor routes
...
const navItems = [
  ...
  { label: 'My Learners', href: '/mentor/learners', icon: Users },
            ...
            <div className="border-t pt-4">
              <div className="rounded-lg bg-muted p-4">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm font-medium">Mentor Resources</p>
                </div>
                <p className="mt-1 text-xs text-muted-foreground">
                  Access guides and best practices for mentoring.
                </p>
