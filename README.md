...
1. Make sure you have PostgreSQL running locally or have access to a PostgreSQL database.
...
```
DATABASE_URL=postgresql://user:password@localhost:5432/risetech
```
...
# 2. Seed with initial data (admin user + sample data)
pnpm db:seed
```
